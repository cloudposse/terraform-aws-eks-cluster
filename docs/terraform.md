...
| <a name="input_kube_exec_auth_api_version"></a> [kube\_exec\_auth\_api\_version](#input\_kube\_exec\_auth\_api\_version) | API version to use when decoding the ExecCredentials resource.<br>Default value matches API version returned by AWS CLI v1 <= 1.20.8 and v2 <= 2.2.23.<br>With newer AWS CLI value should be set to 'client.authentication.k8s.io/v1beta1'. | `string` | `"client.authentication.k8s.io/v1alpha1"` | no |
