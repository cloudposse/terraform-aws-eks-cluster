...
| <a name="input_kube_exec_auth_aws_access_key_id"></a> [kube\_exec\_auth\_aws\_access\_key\_id](#input\_kube\_exec\_auth\_aws\_access\_key\_id) | The aws access key id for `aws eks get-token` to use | `string` | `null` | no |
| <a name="input_kube_exec_auth_aws_profile"></a> [kube\_exec\_auth\_aws\_profile](#input\_kube\_exec\_auth\_aws\_profile) | The AWS config profile for `aws eks get-token` to use | `string` | `""` | no |
| <a name="input_kube_exec_auth_aws_profile_enabled"></a> [kube\_exec\_auth\_aws\_profile\_enabled](#input\_kube\_exec\_auth\_aws\_profile\_enabled) | If `true`, pass `kube_exec_auth_aws_profile` as the `profile` to `aws eks get-token` | `bool` | `false` | no |
| <a name="input_kube_exec_auth_aws_secret_access_key"></a> [kube\_exec\_auth\_aws\_secret\_access\_key](#input\_kube\_exec\_auth\_aws\_secret\_access\_key) | The aws secret access key for `aws eks get-token` to use | `string` | `null` | no |
| <a name="input_kube_exec_auth_aws_session_token"></a> [kube\_exec\_auth\_aws\_session\_token](#input\_kube\_exec\_auth\_aws\_session\_token) | The aws session\_token for `aws eks get-token` to use | `string` | `null` | no |
| <a name="input_kube_exec_auth_credentials_enabled"></a> [kube\_exec\_auth\_credentials\_enabled](#input\_kube\_exec\_auth\_credentials\_enabled) | If `true`, pass `kube_exec_auth_aws_access_key_id`, `kube_exec_auth_aws_secret_access_key` and `kube_exec_auth_aws_session_token` as  `envs` to `aws eks get-token` | `bool` | `false` | no |
