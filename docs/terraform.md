...
| <a name="input_security_group_rules_enabled"></a> [security\_group\_rules\_enabled](#input\_security\_group\_rules\_enabled) | Flag to enable/disable the ingress and egress rules for the additional Security Group | `bool` | `true` | no |
