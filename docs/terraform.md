...
| <a name="input_kube_exec_auth_api_version"></a> [kube\_exec\_auth\_api\_version](#input\_kube\_exec\_auth\_api\_version) | The API version for `aws eks get-token` to use | `string` | `"client.authentication.k8s.io/v1beta1"` | no |
...
| <a name="input_kube_exec_auth_env"></a> [kube\_exec\_auth\_env](#input\_kube\_exec\_auth\_env) | The env for `aws eks get-token` to use | `map(string)` | `{}` | no |
