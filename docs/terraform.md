...
| <a name="input_windows_support"></a> [windows\_support](#input\_windows\_support) | If the module is creating the clusters IAM role the required `AmazonEKSVPCResourceController` will be attached | `bool` | `false` | no |
