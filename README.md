...
| <a name="input_cloudwatch_log_group_class"></a> [cloudwatch\_log\_group\_class](#input\_cloudwatch\_log\_group\_class) | If provided, specifies the log class of the AWS Cloudwatch log group | `string` | `null` | no |
