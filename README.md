...
| <a name="input_kubernetes_elastic_load_balancing_enabled"></a> [kubernetes\_elastic\_load\_balancing\_enabled](#input\_kubernetes\_elastic\_load\_balancing\_enabled) | Indicates if the load balancing capability is enabled on your EKS Auto Mode cluster. If the load balancing capability is enabled, EKS Auto Mode will create and delete load balancers in your Amazon Web Services account. | `bool` | `false` | no |
